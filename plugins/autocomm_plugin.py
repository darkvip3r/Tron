...
register_command_handler(admin_getglobadmin, COMM_PREFIX+'glob_access', ['superadmin','admin','all', 'new'], 300, 'Display all global access', 'glob_access', ['glob_access'])
