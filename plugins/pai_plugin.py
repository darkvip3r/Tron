...
#  fatal pseudo AI plugin v1.0
#  ssh_plugin.py

#  Idea from (C) 2009, Pavel Vishnevsky aka awel
#  Copyright © 2009 wd/lotusfeet <dao/yoga@conference.jabber.ru>
...
def get_pai_phrases(gch):
	...
	phrases = queryphrase('dynamic/'+gch+'/pai_phrases.db',sql)
	return phrases
...
def count_phrase(gch):
	...
	count = queryphrase('dynamic/'+gch+'/pai_phrases.db',sql)
	return count
...
def save_phrase(phrase, gch):
	...
	rep = queryphrase('dynamic/'+gch+'/pai_phrases.db',sql)
	return rep
