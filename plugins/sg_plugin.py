...
register_command_handler(handler_SG_get, COMM_PREFIX+'info', ['info','all','*'], 10, 'Returns statistics about the server of use Xep-0039.', COMM_PREFIX+'info <server>', [COMM_PREFIX+'info jsmart.web.id'])